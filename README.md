...
The initial target is Linux-first development in C#/.NET, engine ECU read-only diagnostics, raw traffic capture, replay/simulation support, and an Avalonia desktop UI.
